<head>
	...
	<link rel="stylesheet" href="/vendors/flat-icon/font/flaticon.css" type="text/css">
	...
	<script src="/vendors/Magnific-Popup/jquery.magnific-popup.min.js" type="text/javascript"></script>
	<script src="/js/jquery.ajaxchimp.min.js" type="text/javascript"></script>
	<script src="/js/jquery.magnific-popup.min.js" type="text/javascript"></script>
	<script src="/js/contaption.js" type="text/javascript"></script>
